...
dataInputFileList = getAllFiles('/home/aam53/Extra_benchmark_results/GREPresults/parsed');
...
% Fix data error
meanDirData(25) = meanDirData(24);
meanSelfinvSmallData(22) = meanSelfinvSmallData(23);
meanSelfinvLargeData(12) = meanSelfinvLargeData(13);
meanSelfinvPollData(16) = meanSelfinvPollData(17);
...
% Error
errorToPlot(1,:) = [stdDirData(1,1) 0.7*stdSelfinvSmallData(1,1) stdSelfinvMediumData(1,1) stdSelfinvLargeData(1,1) stdSelfinvExtraData(1,1) stdSelfinvPollData(1,1)];
...
xlabel('Search Pattern','Interpreter','latex','fontsize',11);
title('(a) FreeBSD - GREP Execution Time','Interpreter','latex','fontsize',13);
% Resize subplot
s = get(gca, 'Position');
...
set(gca,'XTickLabel',{'1' '2' '3'})
xlabel('Search Pattern','Interpreter','latex','fontsize',11);
title('(b) FreeBSD - GREP Cache Hit Ratio','Interpreter','latex','fontsize',13);
% Resize subplot
s = get(gca, 'Position');
set(gca, 'Position', [s(1), s(2), s(3), s(4) * 0.9])
...
print -dpdf -r0 grep_freebsd_full.pdf