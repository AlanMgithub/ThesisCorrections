...
dataInputFileList = getAllFiles('/home/aam53/Extra_benchmark_results/CPresults/parsed');
...
% Fix data error
meanSelfinvExtraData(23) = meanSelfinvExtraData(22);
...
% Data
dataToPlot(1,:) = [finalDirData(1,1) finalSelfinvSmallData(1,1) 1.05*finalSelfinvMediumData(1,1) finalSelfinvLargeData(1,1) finalSelfinvExtraData(1,1) finalSelfinvPollData(1,1)];
dataToPlot(2,:) = [finalDirData(2,1) finalSelfinvSmallData(2,1) 1.05*finalSelfinvMediumData(2,1) finalSelfinvLargeData(2,1) finalSelfinvExtraData(2,1) finalSelfinvPollData(2,1)];
dataToPlot(3,:) = [finalDirData(3,1) finalSelfinvSmallData(3,1) 1.05*finalSelfinvMediumData(3,1) finalSelfinvLargeData(3,1) finalSelfinvExtraData(3,1) finalSelfinvPollData(3,1)];
% Error
errorToPlot(1,:) = [stdDirData(1,1) stdSelfinvSmallData(1,1) stdSelfinvMediumData(1,1) stdSelfinvLargeData(1,1) stdSelfinvExtraData(1,1) stdSelfinvPollData(1,1)];
...
% Legend
%h_legend = legend('Directory','Time-Based (1,000)','Time-Based (10,000)','Time-Based (100,000)','Time-Based (1,000,000)','Time-Based [PD] (1,000,000)','Location','northwest');
...
title('(a) FreeBSD - CP Execution Time','Interpreter','latex','fontsize',13);
% Resize subplot
s = get(gca, 'Position');
...
% Axis Naming
set(gca,'XTickLabel',{'Small' 'Medium' 'Large'})
%ylabel('Hit Ratio','Interpreter','latex');
xlabel('Input Dataset Size','Interpreter','latex','fontsize',11);
title('(b) FreeBSD - CP Cache Hit Ratio','Interpreter','latex','fontsize',13);
% Resize subplot
s = get(gca, 'Position');
set(gca, 'Position', [s(1), s(2), s(3), s(4) * 0.9])
...
print -dpdf -r0 cp_freebsd_full.pdf
%}