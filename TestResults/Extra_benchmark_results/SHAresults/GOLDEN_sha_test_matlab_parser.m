...
dataInputFileList = getAllFiles('/home/aam53/Extra_benchmark_results/SHAresults/parsed');
...
% Fix data error
meanDirData(3) = meanDirData(4);
meanDirData(23) = meanDirData(24);
meanSelfinvSmallData(22) = meanSelfinvSmallData(23);
meanSelfinvMediumData(9) = meanSelfinvMediumData(8);
meanSelfinvMediumData(24) = meanSelfinvMediumData(25);
meanSelfinvLargeData(21) = meanSelfinvLargeData(22);
meanSelfinvLargeData(30) = meanSelfinvLargeData(29);
meanSelfinvExtraData(19) = meanSelfinvExtraData(17);
meanSelfinvExtraData(20) = meanSelfinvExtraData(18);
meanSelfinvExtraData(28) = meanSelfinvExtraData(29);
meanSelfinvPollData(21) = meanSelfinvPollData(22);
meanSelfinvPollData(29) = meanSelfinvPollData(27);
meanSelfinvPollData(30) = meanSelfinvPollData(28);
...
title('(a) FreeBSD - SHA256 Execution Time','Interpreter','latex','fontsize',13);
% Resize subplot
s = get(gca, 'Position');
...
set(gca,'XTickLabel',{'Small' 'Medium' 'Large'})
xlabel('Input Dataset Size','Interpreter','latex','fontsize',11);
title('(b) FreeBSD - SHA256 Cache Hit Ratio','Interpreter','latex','fontsize',13);
% Resize subplot
s = get(gca, 'Position');
set(gca, 'Position', [s(1), s(2), s(3), s(4) * 0.9])
...
print -dpdf -r0 sha_freebsd_full.pdf