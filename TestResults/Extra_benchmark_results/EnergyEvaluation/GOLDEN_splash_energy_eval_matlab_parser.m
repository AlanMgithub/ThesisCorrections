...
dataInputFileList = getAllFiles('/home/aam53/Extra_benchmark_results/EnergyEvaluation/parsed');
%dataInputFileList = getAllFiles('/home/aam53/Extra_benchmark_results/EnergyEvaluation/parsed_2');
...
%ylabel('Hit \& Miss Ratio','Interpreter','latex');
%xlabel('MD5 Input Dataset Size','Interpreter','latex');
title('(c) Time-Based Coherence (1,000,000)','Interpreter','latex','fontsize',13);
...
%ylabel('Hit \& Miss Ratio','Interpreter','latex');
%xlabel('MD5 Input Dataset Size','Interpreter','latex');
title('(b) Time-Based Coherence [Polling Detector] (1,000,000)','Interpreter','latex','fontsize',13);
