...
c=1; while [ $c -le 100000 ]; do
	echo "Count = $c"
	i=0; while [ $i -le 4 ]; do
		time dd if=/dev/zero of=/dev/null bs=1K count=$c	
	i=$((i+1)); 
	done
c=`expr $c \\* $mul`; 
done
...
c=1; while [ $c -le 10000 ]; do
	echo "Count = $c"
	i=0; while [ $i -le 4 ]; do
		time dd if=/dev/zero of=/dev/null bs=10K count=$c	
	i=$((i+1)); 
	done
c=`expr $c \\* $mul`; 
done
...
c=1; while [ $c -le 1000 ]; do
	echo "Count = $c"
	i=0; while [ $i -le 4 ]; do
		time dd if=/dev/zero of=/dev/null bs=100K count=$c	
	i=$((i+1)); 
	done
c=`expr $c \\* $mul`; 
done
...
c=1; while [ $c -le 100 ]; do
	echo "Count = $c"
	i=0; while [ $i -le 4 ]; do
		time dd if=/dev/zero of=/dev/null bs=1M count=$c	
	i=$((i+1)); 
	done
c=`expr $c \\* $mul`; 
done
